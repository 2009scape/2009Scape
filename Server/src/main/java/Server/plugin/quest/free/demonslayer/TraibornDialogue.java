...
public class TraibornDialogue extends DialoguePlugin {
	...
	public boolean handle(int interfaceId, int buttonId) {
		switch (stage) {
		case 0:
			if (quest.getStage(player) == 20 && !player.hasItem(DemonSlayer.THIRD_KEY)) {
		...
		case 11:
			...
			break;
		case 12:
			interpreter.sendOptions("Select an Option", "Err you just called me a thingummywut.", "Tell me what they look like and I'll mash 'em.");
			stage = 13;
			break;
		case 13:
			switch (buttonId) {
