...
final class Class42 {
   ...
   static Object method1055(String var0, Applet var2) throws Throwable {
      return (byte) -111 > -87?(Object)null:JSObject.getWindow(var2).call(var0, (Object[])null);
   }

   static Object method1056(Applet var0, Object[] var2) throws Throwable {
      int var4 = -90 / (((byte) 117 - 40) / 55);
      return JSObject.getWindow(var0).call("openjs", var2);
   }

   static void method1057(Applet var0, boolean var1, String var2) throws Throwable {
