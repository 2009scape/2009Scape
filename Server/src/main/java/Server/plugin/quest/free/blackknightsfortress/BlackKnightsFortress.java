	...
	public void drawJournal(Player player, int stage) {
		...
		case 0:
			line = writeJournal(player,
				"I can start this quest by speaking to the <red>Sir Amik Varze<blue>at the",
		...
		case 10:
			writeJournal(player,
				...
				"I need to disguise myself to gain entry to the <red>Black",
		...
		case 20:
			...
			writeJournal(player, line,
				...
				"and discovered that their invincibility potion can be",
				"destroyed with a normal <red>cabbage.");
			break;
		case 30:
			line = writeJournal(player, true,
				"Sir Amik Varze asked me to investigate the Black Knights'",
			...
			writeJournal(player, line,
				"Now that I have sabotaged the witch's potion, I can claim",
				"my <red>reward <blue>from <red>Sir Amik Varze <blue>in <red>Falador Castle.");
			break;
		case 100:
			line = writeJournal(player, true,
				"Sir Amik Varze asked me to investigate the Black Knights'",
