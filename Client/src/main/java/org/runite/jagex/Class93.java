  ...
  /** static final void method1517(byte var0) {
   ...
   static final void method1517(byte var0) {
	      try {
	         ...
	         throw Class44.clientError(var2, "n.J(" + var0 + ')');
	      }
	   }
   ...
   final int method1520(int var1) {
      try {
         ...
         throw Class44.clientError(var4, "n.D(" + var1 + ')');
      }
   }
   ...
   final void method1524(int var1) {
      try {
         ...
         throw Class44.clientError(var3, "n.H(" + var1 + ')');
      }
   }
   ...
   static final void method1525(int var0, int var1, int var2, int var3, int var4, int var5) {
      try {
         ...
         throw Class44.clientError(var11, "n.I(" + var0 + ',' + var1 + ',' + var2 + ',' + var3 + ',' + var4 + ',' + var5 + ')');
      }
   }
   ...
   final Object get(long key, byte var3) {
      try {
         ...
         throw Class44.clientError(var7, "n.K(" + key + ',' + var3 + ')');
      }
   }
