   ...
   final void method31(String var1, int var2) {
      try {
         if(!this.aBoolean1) {
            ...
            JOptionPane.showMessageDialog(frame, "Eeeerror: " + var1 + (var1.contains("js5connect") ? ". The game is likely down." : "") + "\nCheck Discord (https://discord.gg/Z6sF4Vd) or Github (https://github.com/2009scape/2009scape) for a potential solution.");            try {
