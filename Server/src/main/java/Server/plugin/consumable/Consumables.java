...
public enum Consumables {
	...
	GARDEN_PIE(new HalfableFood(new int[] {7178, 7180, 2313}, new MultiEffect(new HealingEffect(6), new IncrementSkillEffect(Skills.FARMING, 3, 0)))),
	...
	/** Ales */
	ASGARNIAN_ALE(new Drink(new int[] {1905, 1919}, new MultiEffect(new HealingEffect(2), new IncrementSkillEffect(Skills.STRENGTH, 2, 0), new IncrementSkillEffect(Skills.ATTACK, -4, 0)), "You drink the ale. You feel slightly reinvigorated...", "...and slightly dizzy too.")),
	ASGARNIAN_ALE_KEG(new Drink(new int[] {5785, 5783, 5781, 5779, 5769}, new MultiEffect(new IncrementSkillEffect(Skills.STRENGTH, 2, 0), new IncrementSkillEffect(Skills.ATTACK, -4, 0)), new Animation(2289), "You drink the ale. You feel slightly reinvigorated...", "...and slightly dizzy too.")),
	...
	BANDITS_BREW(new Drink(new int[] {4627, 1919}, new MultiEffect(new IncrementSkillEffect(Skills.THIEVING, 1, 0), new IncrementSkillEffect(Skills.ATTACK, 1, 0), new IncrementSkillEffect(Skills.STRENGTH, -1, 0), new IncrementSkillEffect(Skills.DEFENCE, -6, 0), new HealingEffect(1)), "You drink the beer. You feel slightly reinvigorated...", "...and slightly dizzy too.")),
	BEER(new Drink(new int[] {1917, 1919}, new MultiEffect(new HealingEffect(1), new IncrementSkillEffect(Skills.STRENGTH, 0, 0.04), new IncrementSkillEffect(Skills.ATTACK, 0, -0.07)), "You drink the beer. You feel slightly reinvigorated...", "...and slightly dizzy too.")),
	...
	DWARVEN_STOUT(new Drink(new int[] {1913, 1919}, new MultiEffect(new IncrementSkillEffect(Skills.MINING, 1, 0), new IncrementSkillEffect(Skills.SMITHING, 1 ,0), new IncrementSkillEffect(Skills.ATTACK, -2, 0), new IncrementSkillEffect(Skills.STRENGTH, -2, 0), new IncrementSkillEffect(Skills.DEFENCE, -2, 0), new HealingEffect(1)), "You drink the Dwarven Stout. It tastes foul.", "It tastes pretty strong too.")),
	DWARVEN_STOUT_KEG(new Drink(new int[] {5777, 5775, 5773, 5771, 5769}, new MultiEffect(new IncrementSkillEffect(Skills.MINING, 1, 0), new IncrementSkillEffect(Skills.SMITHING, 1 ,0), new IncrementSkillEffect(Skills.ATTACK, -2, 0), new IncrementSkillEffect(Skills.STRENGTH, -2, 0), new IncrementSkillEffect(Skills.DEFENCE, -2, 0), new HealingEffect(1)), new Animation(2289), "You drink the Dwarven Stout. It tastes foul.", "It tastes pretty strong too.")),
	...
	CUP_OF_TEA_CLAY_MILKY(new Drink(new int[] {7731, 7728}, new IncrementSkillEffect(Skills.CONSTRUCTION, 1, 0))),
	CUP_OF_TEA_WHITE(new Drink(new int[] {7733, 7732}, new IncrementSkillEffect(Skills.CONSTRUCTION, 2, 0), "You feel refreshed and ready for more building.")),
	CUP_OF_TEA_WHITE_MILKY(new Drink(new int[] {7734, 7732}, new IncrementSkillEffect(Skills.CONSTRUCTION, 2, 0))),
	CUP_OF_TEA_GOLD(new Drink(new int[] {7736, 7735}, new IncrementSkillEffect(Skills.CONSTRUCTION, 3, 0), "You feel refreshed and ready for more building.")),
	CUP_OF_TEA_GOLD_MILKY(new Drink(new int[] {7737, 7735}, new IncrementSkillEffect(Skills.CONSTRUCTION, 3, 0))),
	...
	STR_MIX(new BarbarianMix(new int[] {11443, 11441}, new MultiEffect(new IncrementSkillEffect(Skills.STRENGTH, 3, 0.1), new HealingEffect(3)))),
	...
	DEF_MIX(new BarbarianMix(new int[] {11457, 11459}, new MultiEffect(new IncrementSkillEffect(Skills.DEFENCE, 3, 0.1), new HealingEffect(6)))),
	AGIL_MIX(new BarbarianMix(new int[] {11461, 11463}, new MultiEffect(new IncrementSkillEffect(Skills.AGILITY, 3, 0), new HealingEffect(6)))),
	COMBAT_MIX(new BarbarianMix(new int[] {11445, 11447}, new MultiEffect(new IncrementSkillEffect(Skills.ATTACK, 3, 0.1), new IncrementSkillEffect(Skills.STRENGTH, 3, 0.1), new HealingEffect(6)))),
	SUPER_ATT_MIX(new BarbarianMix(new int[] {11469, 11471}, new MultiEffect(new IncrementSkillEffect(Skills.ATTACK, 5, 0.15), new HealingEffect(6)))),
	FISH_MIX(new BarbarianMix(new int[] {11477, 11479}, new MultiEffect(new IncrementSkillEffect(Skills.FISHING, 3, 0), new HealingEffect(6)))),
	SUPER_ENERGY_MIX(new BarbarianMix(new int[] {11481, 11483}, new MultiEffect(new EnergyEffect(20), new HealingEffect(6)))),
	HUNTING_MIX(new BarbarianMix(new int[] {11517, 11519}, new MultiEffect(new IncrementSkillEffect(Skills.HUNTER, 3, 0), new HealingEffect(6)))),
	SUPER_STR_MIX(new BarbarianMix(new int[] {11485, 11487}, new MultiEffect(new IncrementSkillEffect(Skills.STRENGTH, 5, 0.15), new HealingEffect(6))));
